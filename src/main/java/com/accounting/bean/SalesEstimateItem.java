 ...
 */
@Entity
@Table(name = "sales_estimate_item")
public class SalesEstimateItem implements Serializable {
    ...
    public SalesEstimateItem() {
    }

    public SalesEstimateItem(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SalesEstimateItem)) {
            return false;
        }
        SalesEstimateItem other = (SalesEstimateItem) object;
    ...
    public String toString() {
        return "com.accounting.bean.SalesEstimateItem[ id=" + id + " ]";
    }
