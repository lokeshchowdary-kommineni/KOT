...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Accounting-SaleReturn Reports</title>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="#">SaleReturn Register</a>
							</li>
                                                        <li>
								<a href="#">SaleReturn Records</a>
							</li>
							<li class="active">SaleReturn Reports</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
                                                            ...
                                                            <!-- /.row -->
                                                       <div class="col-xs-12">
                                                           <form class="form-horizontal" action="GetSaleReturnReport.html"   method="POST" target="_blank">             
                                                               <div class="widget-box lighter  widget-color-blue2">
                                                                    <div class="widget-header">
                                                                <h5 class="widget-title">Sale Return Reports</h5>
                                                                    </div>
