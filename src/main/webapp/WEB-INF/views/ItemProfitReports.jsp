...
<html lang="en">
	...
	<body class="no-skin">
        ...
        <c:forEach items="${listGroup}" var="group">
            <c:choose>
                <c:when test="${group.moduleName=='ItemProfitReports'}">
						...
						<ul class="breadcrumb">
							<li>
								...
								<a href="#">Home</a>
                                                        ...
                                                        <li class="active">Item Profit Reports</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>Item Profit Reports</h1>
                                                           ...
                                                           <div class="col-xs-12">
                                                               <form id="wizardForm" action="GetItemSalesReports.html"  method="POST" target="_blank" onsubmit="if($('input[name=type]:checked').length<=0){ alert('Select Atleast one Checkbox'); return false;}">
                                                               <div class="widget-box lighter  widget-color-blue2">
                                                                    <div class="widget-header">
                                                                <h5 class="widget-title">Item Profit Reports</h5>
                                                                    </div>
    ...
    <div class="form-group col-sm-3">
     ...
     <div class="form-group col-sm-3">
                                    <label for="id-date-picker-1">To Date</label>
										...
										<div class="col-sm-12" id="replaceItem">
                                                ...
                                                <option value=""></option>
                                                 <c:forEach items="${itemList}" var="il">
                                                    <option value="${il.itemCode}" ${il.id==item ?'Selected':''}>${il.itemName}</option>
                                                </c:forEach>   
                                                                                         </select> 
										</div>
									</div> 
										...
										<label class="lbl" for="ace-settings-navbar"> Voucher Wise</label>
										...
										<label class="lbl" for="ace-settings-navbar"> Item Wise</label>
