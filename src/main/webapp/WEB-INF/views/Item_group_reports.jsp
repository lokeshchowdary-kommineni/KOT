...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Item Group Report-Accounting</title>
	...
	<body class="no-skin">
        ...
        <c:forEach items="${listGroup}" var="group">
            <c:choose>
                <c:when test="${group.moduleName=='Item_group_reports'}">
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Item Group Summary</li>
						</ul><!-- /.breadcrumb -->
...
<form class="form-horizontal" role="form" target="_blank" action="GroupPreview.html" modelAttribute="reportForm" method="GET" onsubmit="if($('input[name=type]:checked').length<=0){ alert('Select Atleast one Checkbox'); return false;}">
						<div class="row">			
										...
										<div class="col-sm-12">
                                                                                    <select   name="itemgroup" class="form-control" id="groupid" required="true" >
