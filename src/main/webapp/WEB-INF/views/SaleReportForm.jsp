...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Accounting-Purchase Reports</title>
	...
	<body class="no-skin">
        ...
        <c:forEach items="${listGroup}" var="group">
            <c:choose>
                <c:when test="${group.moduleName=='SaleReportForm'}">
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="#">Sale Report Register</a>
							</li>
                                                        <li>
								<a href="#">Sale  Records</a>
							</li>
					...
					<div class="page-content">
                                                            ...
                                                            <!-- /.row -->
                                                       <div class="col-xs-12">
                                                           <form class="form-horizontal" action="GetSaleReport.html"   method="POST" target="_blank">             
                                                               <div class="widget-box lighter  widget-color-blue2">
                                                                    <div class="widget-header">
                                                                <h5 class="widget-title">Sale Reports</h5>
                                                                    </div>
