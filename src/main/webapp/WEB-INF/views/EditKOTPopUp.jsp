                                                ...
                                                <div class="widget-main no-padding">
                                                    <table class="table table-striped table-bordered table-hover" id="example1">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center;"><a href="#"  class="ace-icon fa fa-trash-o bigger-120 btn-danger" onclick="myFunctionDeleteFromSales(this,${fn:length(kotForm.kotItem)},${status.index})"></a></td>
                                                        </tr>
                                                        </tbody>
                                                        </c:forEach>
                                                    </table>
