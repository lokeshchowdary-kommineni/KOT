								...
								<form:form class="form-horizontal" action="SavePurchaseEstimate.html"  commandName="purchaseEFrom" method="POST" id="pEFrom" autocomplete="Off">
								 <div class="widget-box lighter  widget-color-blue2">
										...
										<div class="col-sm-12">
                                                                                    ...
                                                                                    <form:input type="text" path="epurchase.purchaseEstimateId"  placeholder="invoice no" class="form-control" readonly="true"/>
										...
										<div class="col-sm-12">
                                                                                   <form:input path="epurchase.date" class="form-control date-picker" id="id-date-picker-1" placeholder="date" type="text" data-date-format="dd/mm/yyyy" required="true"/>
                                                                                 
											
										</div>
									</div>
                                                                                    <div class="form-group col-xs-3" >
										<label class="col-sm-12" for="form-field-1"> POP</label>
										<div class="col-sm-12">
                                                                                        <form:select path="epurchase.pos"  class="form-control" id="pos" required="true" onChange="posStatesEqual()" oninput="setCustomValidity('')"  oninvalid="setCustomValidity('  Please Select Pos')">
