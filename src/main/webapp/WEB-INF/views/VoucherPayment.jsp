...
<html>
    ...
    <head>
        ...
        <title>Accounting -Payment Voucher</title>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="VoucherReceipt&PaymentGrid.html">Payment Voucher Records</a>
							</li>
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="row">
										...
										<label class="col-sm-6" for="form-field-1"> Payment No<span style="color:red;">*</span></label>
										...
										<div class="col-sm-10">
											...
											<form:errors path="vouchId" />
                                                                    ...
                                                                    <form:hidden path="vouchId" id="pId"/>
                                                                     <form:hidden path="vouchType" name="vouchType" value="payment" />
										...
										<div class="col-sm-10">
											<form:input path="vouchAmount" type="number" id="Box1" step="0.01" oninvalid="setCustomValidity('Please enter Numbers ')" onchange="try{setCustomValidity('')}catch(e){}" min="0"  placeholder="voucher amount" class="form-control" required="true"/>
								...
								<div class="row">
									...
									<div class="form-group col-xs-3">
										<label class="col-sm-12" for="form-field-1"> Name of Account <span style="color:red;">*</span></label>

										<div class="col-sm-10">

                                                                                    <form:select path="vouchFrom" class="form-control disable changeFromRecAndPay" id="changeFrom" >
                                                                                        <form:option value="0" label="---choose---" selected="selected"/>
										...
										<div class="col-sm-3">
                                                                            ...
                                                                            <div class="col-sm-7">
                                                                                        ...
                                                                                        <div class="col-sm-3">
                                                                                        <input value="${typeF}"  type="text"  class="form-control" readonly="true"/>
								...
								<div class="row" id="hideForCheque">
										...
										<label class="col-sm-6" for="form-field-1">Cheque/Transfer no</label>

										<div class="col-sm-10">
											<form:input path="vouchCheqNo" type="text" id="form-field-1" placeholder="cheque no" class="form-control" />
								...
								<div class="row">	
										...
										<label class="col-sm-6" for="form-field-1"> Cash Ledgers <span style="color:red;">*</span></label>
									...
									<div class="form-group col-xs-3 hideForType" id="showBankGroup">
										...
										<div class="col-sm-3">
											...
											<input value="${currentTOmBalance}"  type="text" placeholder="balance" class="form-control" readonly="true"/>
                                                                                ...
                                                                                <div class="col-sm-3">
                                                                                        <input value="${typeT}"  type="text"  class="form-control" readonly="true"/>
									...
									<div style="text-align:center">
                                                                             <c:if  test="${empty vpId || vpId==0}"> 
                                                                            <input type="submit" id="btnSubmit" class="btn btn-success" value="Save">
                                                                            <button class="btn" type="reset">  Reset </button>
                                                                              </c:if>
                                                                            <c:if  test="${not empty vouchPaymentReceipt.vouchId}">
                                                                                <a href="VoucherPaymentPrint.html?id=${vouchPaymentReceipt.vouchId}" class="btn btn-default">Print</a>
                                                                            </c:if>
