				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Waiter Report</li>
						</ul><!-- /.breadcrumb -->
					    ...
					    <div class="row">
                                                <div class="col-xs-12">
                                                      ...
                                                      <div class="table-header">
                                                        ...
                                                        <br>
                                                        <form action="WaiterItemReport.html" method="post">                                                 
                                                        <div class="row">
                                                        <div class="form-group">
                                                            <div class="form-group col-sm-3 ">
                                                                <label for="form-field-mask-1"> Waiter Name <span style="color:red;">*</span></label>
                                                                <select name='waitername' class="form-control" >
                                                                    <option value="${selected}" selected>${selected}</option>
                                                                    <c:forEach items="${waiterList}" var="w">
                                                                        <c:if test="${w.id != selected}">
                                                                            <option value="${w.id}">${w.waiterName}</option>
                                                                        </c:if>
                                                                    </c:forEach>
                                                                </select>
                                                            </div>
								...
								<label class="col-sm-8 " ><span style="color:red;">*</span> From Date </label>
                                                        ...
                                                        <div>
                                                                ...
                                                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                                      ...
                                                                      <tbody>
                                            <c:forEach items="${list}" var="empinfo">
                                                <tr>
                                                   <td>${empinfo[0]}</td> 
                                                   <td>${empinfo[1]}</td> 
                                                   <td>${empinfo[2]}</td> 
