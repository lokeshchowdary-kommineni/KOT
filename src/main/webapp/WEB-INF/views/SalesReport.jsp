									...
									<div class="col-xs-12">
										<!--<h3 class="header smaller lighter blue">Buyer List</h3>-->
                                                                              <div class="table-header">
                                                                                ...
                                                                                <form action="SalesReportbydate.html" method="post">                                                 
                                                                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-md-3">
                                            <label for="form-field-mask-1">From Date <span style="color:red;">*</span></label>
                                            
                                            <input type="text" class="form-control" id="startDatePicker" name="FromDate">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="form-field-mask-2">To Date<span style="color:red;">*</span> </label>
