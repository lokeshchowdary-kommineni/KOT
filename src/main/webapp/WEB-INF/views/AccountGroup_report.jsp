...
<html>
    ...
    <head>
        ...
        <title>Accounting - Account Group Summary</title>
    ...
    <body class="no-skin">
        ...
        <c:forEach items="${listGroup}" var="group">
            <c:choose>
                <c:when test="${group.moduleName=='AccountGroup_report'}">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form  target="_blank"action="AccountGroupSummary.html" method="GET" onsubmit="if($('input[name=type]:checked').length<=0){ alert('Select Atleast one Checkbox'); return false;}">
								<div class="row">
                                                                    ...
                                                                    <label>Date Range</label>
                                                                        ...
                                                                        <div class="form-group col-xs-3 hideForLedger2 ">
                                                                                    ...
                                                                                    <div class="col-sm-10">
                                                                                        <select class="form-control mySelects" id="changeGetAcGroups" name="byAccountGroups" required="true">
                                                                           ...
                                                                           </div>              <input type="hidden" name="groupName" id="groupName">
<!--                                                                        <div class="form-group col-xs-3 " >
										...
										<label class="lbl" for="ace-settings-navbar">Group wise</label>
...
<![endif]-->
		...
		<script type="text/javascript">
				...
				//show datepicker when clicking on the icon
				 $(document).on("change", "#changeGetAcGroups", function() {
