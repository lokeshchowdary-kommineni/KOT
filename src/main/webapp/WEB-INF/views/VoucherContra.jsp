...
<html>
    <head>
        ...
        <![endif]-->
        <style>
            #vouchContraForCheq , #vouchContraForCheqDate,#vouchContraForCheqTransfer, #showBankName,#CashTypeFrom,#BankTypeFrom,#cashTypeTo,#BankTypeTo,#chooseType{
                display:none;
            }
                    ...
                    <div class="row">
                            <div class="col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" name="fromLedger" id="fromLedger">
                                         <input type="hidden" name="toLedger" id="toLedger">
                                          <input type="hidden" name="chequeNo" id="chequeNo">
                                            ...
                                            <div class="form-group col-xs-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                            <form:input path="vouchCashDate" class="form-control date-picker" id="id-date-picker-1" placeholder="date" type="text" data-date-format="dd/mm/yyyy" />
                                                    ...
                                                    <div class="col-sm-10">
                                                        <form:select path="vouchType" class="form-control changeModeForContra" id="changeMode">
                                                                <form:option value="cash" label="Deposit" selected="selected"/>
                                                                <form:option value="cheque" label="Withdrawal"/>
                                                    ...
                                                    <div class="form-group col-xs-3">
                                                        <label class="col-sm-6" for="form-field-1"> Voucher Amount<span style="color:red;">*</span></label></p>

                                                    <div class="col-sm-10">
                                                        <form:input path="vouchAmount" type="number" id="Box1" step="0.01" oninvalid="setCustomValidity('Please enter Numbers ')" onchange="try{setCustomValidity('')}catch(e){}" min="0" placeholder="amount" class="form-control" required="true"/>
                                            ...
                                            <div class="form-group col-xs-3">
                                                    ...
                                                    <div class="col-sm-10"  id="changeFromContra3"> 
                                                          <label class="col-sm-12" for="form-field-1">From (Cash Ledgers)<span style="color:red;">*</span></label> 
                                                                    <form:select path="vouchFrom" class="form-control changeFromContra changeFrom changeFromContra3" id="changeFromContra" required="true">
                                               ...
                                               <div class="col-sm-10"  id="changeFromContra1" hidden>
                                                           <c:if test="${vouchType!='cash' && vouchType!='transfer'}">
                                                              <label class="col-sm-12" for="form-field-1"> From (Bank Ledgers) <span style="color:red;">*</span></label>  
                                                                <form:select path="vouchFrom" class="form-control changeFromContra changeFrom changeFromContra1" id="changeFromContra">
                                                                    <form:option value="" label="Choose"/>
                                                        ...
                                                        <%--<form:errors path="vouchFrom" />--%>
                                                            ...
                                                            <div class="col-sm-10"  id="CashTypeFrom"  >
                                                              <c:if test="${vouchType!='cheque' && vouchType!='cash'}">
                                                                ...
                                                                <form:select path="vouchFrom" class="form-control changeFromContra changeFrom CashTypeFrom" id="changeFromContra">
                                                                    <form:option value="" label="Choose"/>
                                                                         <c:forEach items="${TypeCash}" var="list2">
                                                        ...
                                                        <%--<form:errors path="vouchFrom" />--%>
                                                            ...
                                                            <div class="col-sm-10"  id="BankTypeFrom" hidden>
                                                              <c:if test="${vouchType!='cheque' && vouchType!='cash'}">
                                                                  <label class="col-sm-12" for="form-field-1"> From (Cash/Bank Ledgers)<span style="color:red;">*</span></label> 
                                                                <form:select path="vouchFrom" class="form-control changeFromContra changeFrom BankTypeFrom" id="changeFromContra">
                                                                    <form:option value="" label="Choose"/>
                                                                         <c:forEach items="${TypeBank}" var="list2">
                                                                            <form:option value="${list2[1]}" label="${list2[0]}"/>
                                                                         </c:forEach>
                                                                </form:select>
                                                             </c:if>
									...
									<div class="form-group col-xs-4">
                                                          ...
                                                          <div class="col-sm-7">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <input value="${AFROM}"  type="text"  class="form-control" readonly="true"/>
                                                 ...
                                                 <div class="col-sm-10" id="chooseType" >
                                                        <label class="col-sm-12" for="form-field-1">Choose Type</label> 

                                                                                                <div class="radio">
													<label>
														 <input name="types" type="radio" value="bank" onclick="findType(this.value)"  />
												...
												<div class="radio">
													<label>
														<input name="types" type="radio" value="cash" onclick="findType(this.value)"  />    
                                    ...
                                    <div class="row" id="">
<!--                                            <div class="form-group col-xs-4" id="showBankName" hidden>
                                                    <label class="col-sm-6" for="form-field-1"> Name of the bank </label>

                                                    <div class="col-sm-10">
                                                            <form:input path="vouchBankName" type="text" id="bankName" placeholder="bank name" class="form-control"/>
                                            ...
                                            <div class="form-group col-xs-3" id="vouchContraForCheq">
                                                    ...
                                                    <div class="col-sm-10">
                                                            <form:input path="vouchCheqNo" type="text" id="cn" placeholder="cheque no" class="form-control chequeNo"/>
                                            ...
                                            <div class="form-group col-xs-3" id="vouchContraForCheqDate">  
                                                    <label class="col-sm-6" for="form-field-1"> Date </label>
                                            ...
                                            <div class="form-group col-xs-3">
                                                    ...
                                                    <div class="col-sm-10" id="changeTo1" >
                                                         <label class="col-sm-12" for="form-field-1"> To (Bank Ledgers)<span style="color:red;">*</span></label>
                                                        <form:select path="vouchTo" class="form-control disable changeToContra changeTo changeTo1" id="changeTo" required="true">
                                                            <form:option value="" label="Choose"/>
                                                     ...
                                                     <div class="col-sm-10" id="changeTo2" hidden>
                                                          <label class="col-sm-12" for="form-field-1"> To (Cash Ledgers) <span style="color:red;">*</span></label>
                                                        <form:select path="vouchTo" class="form-control disable changeToContra changeTo changeTo2" id="changeTo">
                                                            <form:option value="" label="Choose"/>
                                                     ...
                                                     <div class="col-sm-10" id="cashTypeTo" hidden>
                                                          <label class="col-sm-12" for="form-field-1"> To (Cash/Bank Ledgers)<span style="color:red;">*</span></label>
                                                        <form:select path="vouchTo" class="form-control disable changeToContra changeTo cashTypeTo" id="changeTo">
                                                            <form:option value="" label="Choose"/>
                                                            <c:forEach items="${TypeCash}" var="list2">
                                                                <form:option value="${list2[1]}" label="${list2[0]}"/>
                                                            </c:forEach>
                                                     ...
                                                     <div class="col-sm-10" id="BankTypeTo" hidden>
                                                          <label class="col-sm-12" for="form-field-1"> To (Cash/Bank Ledgers)<span style="color:red;">*</span></label>
                                                        <form:select path="vouchTo" class="form-control disable changeToContra changeTo BankTypeTo" id="changeTo">
                                                            <form:option value="" label="Choose"/>
                                                            <c:forEach items="${TypeBank}" var="list2">
                                                                <form:option value="${list2[1]}" label="${list2[0]}"/>
                                                            </c:forEach>
                                               ...
                                               <div class="form-group col-xs-4">
                                                 <label class="col-sm-6" for="form-field-1"><span style="color:green;"> Current Closing Balance</span></label>
                                                        ...
                                                        <div class="col-sm-7">
                                                         ...
                                                         <div class="col-sm-3">
                                                            <input value="${BTO}"  type="text"  class="form-control" readonly="true"/>
...
<script type="text/javascript">
        ...
        function findType() {
        	...
        	var radioValue = $("input[name='types']:checked").val();
              if(radioValue == 'bank'){
               $("#BankTypeFrom").show();
                    $(".BankTypeFrom").prop('required',true);
                 $("#BankTypeTo").show();
                     $(".BankTypeTo").prop('required',true);
                  $("#vouchContraForCheqTransfer").show(); 
                     
                  $("#vouchContraForCheqDate").show();
                 $("#CashTypeFrom").hide(); 
                    $(".CashTypeFrom").prop('required',null);
                $("#cashTypeTo").hide();
                    $(".cashTypeTo").prop('required',null);

            }
            else
            { 
                 $("#BankTypeFrom").hide();
                    $(".BankTypeFrom").prop('required',null);
                 $("#BankTypeTo").hide();
                     $(".BankTypeTo").prop('required',null);
                  $("#vouchContraForCheqTransfer").hide();                      
                  $("#vouchContraForCheqDate").hide();
                 $("#CashTypeFrom").show(); 
                    $(".CashTypeFrom").prop('required',true);
                $("#cashTypeTo").show();
                    $(".cashTypeTo").prop('required',true);
   ...
   <script type="text/javascript">
     $(document).on("change", ".changeFrom", function() {
                          $('#fromLedger').val($(this).find("option:selected").val());
     });   
     $(document).on("change", ".changeTo", function() {
                          $('#toLedger').val($(this).find("option:selected").val());
     });
     $(document).on("change", ".chequeNo", function() {
                          $('#chequeNo').val($(this).val());
     });
    $(function () {
        $("#changeMode").change(function () {
            if ($(this).val() == 'cash') {
                $("#changeFromContra3").show();
                    $(".changeFromContra3").prop('required',true);
                 $("#changeFromContra1").hide();
                     $(".changeFromContra1").prop('required',null);
                  $("#changeFromContra2").hide(); 
                      $(".changeFromContra2").prop('required',null);
...
//                   $("#showBankName").hide();
                ...
                $("#changeFromContra3").hide();
                     $(".changeFromContra3").prop('required',null);
                 $("#changeFromContra1").show();
                      $(".changeFromContra1").prop('required',true);
                  $("#changeFromContra2").hide(); 
                      $(".changeFromContra2").prop('required',null);
                ...
                $("#changeFromContra3").hide();
                 ...
                 $("#changeFromContra1").hide();
                  ...
                  $("#changeFromContra2").show();
                     $(".changeFromContra2").prop('required',true);
                  $('#showBankName').show();
                  $("#vouchContraForCheq").hide();            
                   $("#vouchContraForCheqTransfer").hide();
                    $("#vouchContraForCheqDate").hide();
...
<script type="text/javascript">
    $(function () {
        $("#changeMode").change(function () {
            if ($(this).val() == 'cash') {
                $("#changeTo1").show();
                     $(".changeTo1").prop('required',true);
                 $("#changeTo2").hide();
                      $(".changeTo2").prop('required',null);
                  $("#changeTo3").hide();
                       $(".changeTo3").prop('required',null);
                   $("#CashTypeFrom").hide(); 
                         $(".CashTypeFrom").prop('required',null);
                  $("#cashTypeTo").hide();
                         $(".cashTypeTo").prop('required',null);
                ...
                $("#changeTo1").hide();
                    $(".changeTo1").prop('required',null);                   
                 $("#changeTo2").show();
                     $(".changeTo2").prop('required',true);               
                  $("#changeTo3").hide();
                      $(".changeTo3").prop('required',null); 
                   $("#CashTypeFrom").hide(); 
                         $(".CashTypeFrom").prop('required',null); 
                  $("#cashTypeTo").hide();
                        $(".cashTypeTo").prop('required',null);
                    // $("#cashTypeTo :input:select").prop('required',null);
                ...
                $("#changeTo1").hide();
                 ...
                 $("#changeTo2").hide();
                    $(".changeTo2").prop('required',null);
                  $("#changeTo3").show(); 
                     $(".changeTo3").prop('required',true);
                  $("#CashTypeFrom").show(); 
                    $(".CashTypeFrom").prop('required',true);
                  $("#cashTypeTo").show();
                    $(".cashTypeTo").prop('required',true);
                  $("#chooseType").show();
                    $(".chooseType").prop('required',true);
