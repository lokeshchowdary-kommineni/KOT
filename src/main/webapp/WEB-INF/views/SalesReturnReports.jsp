...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Accounting-Sales Return Grid</title>
	...
	<body class="no-skin">
        ...
        <c:forEach items="${listGroup}" var="group">
            <c:choose>
                <c:when test="${group.moduleName=='SalesReturnReports'}">
					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="SalesReturn.html">Sales Return</a>
							</li>
                                                        <li>
								
								<a href="SalesReturnGrid.html">Sales Return Records</a>
							</li>
                                                        <li>
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>Sales Return Register</h1>
                                                            ...
                                                            <!-- /.row -->
                                                       <div class="col-xs-12">
                                                             <form id="wizardForm" action="SalesReturnReports.html"  method="POST">
                                                             <div class="widget-box lighter  widget-color-blue2">
                                                                    <div class="widget-header">
                                                                <h5 class="widget-title">Sales Return Register</h5>
                                                                    </div>
										...
										<div>
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
                                                                                                    ...
                                                                                                    <c:forEach items="${SalesReturnListFullinfo}" var="salesInfo">
													<tr>
