							...
							<div class="col-xs-12">
								...
								<div class="row">
                                                                    ...
                                                                    <div class="form-group col-xs-3 hideForLedger1">
                                                                                    ...
                                                                                    <div class="col-sm-10">
                                                                                        <select class="form-control changeGetLedger" id="changeGetLedger" name="byLedger">
                                                                        ...
                                                                        <div class="form-group col-xs-3 hideForLedger2">
                                                                                    ...
                                                                                    <div class="col-sm-10">
                                                                                        <select class="form-control" id="changeGetAcGroups" name="byAccountGroups">
                                                                                            <option value="-1">---choose---</option>
                                                                                            
                                                                                            <c:forEach items="${accountGroupList}" var="list">
                                                                                                <option value="${list.idAccount}">${list.accountGroupName}</option>
                                                                                            </c:forEach>
                                                                                        </select>
                                                                                    </div>
                                                                            </div>
                                                                    ...
                                                                    <div>
                                                                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <c:choose>
                                                                                                <c:when test="${ledgerDetail.openingType == 'DR'}">
                                                                                                  <td colspan="3"><b>To Opening Balance</b></td>
                                                                                                </c:when>
                                                                                                <c:when test="${ledgerDetail.openingType == 'CR'}">
                                                                                                  <td colspan="3"><b>By Opening Balance</b></td>
                                                                                                </c:when>
                                                                                                <c:otherwise>
                                                                                                  <td colspan="3"><b>Opening Balance</b></td>
                                                                                                </c:otherwise>
                                                                                            </c:choose>
                                                                                            <td>${ledgerDetail.openingDate}</td>
                                                                                            <c:choose>
                                                                                                <c:when test="${(ledgerDetail.openingType == 'DR') && (ledgerDetail.openingAmount != null)}">
                                                                                                  <td>${ledgerDetail.openingAmount}</td>
                                                                                                </c:when>
                                                                                                <c:otherwise>
                                                                                                  <td>-</td>
                                                                                                </c:otherwise>
                                                                                            ...
                                                                                            <c:choose>
                                                                                                <c:when test="${(ledgerDetail.openingType == 'CR') && (ledgerDetail.openingAmount != null)}">
                                                                                                  <td>${ledgerDetail.openingAmount}</td>
                                                                                                </c:when>
                                                                                                <c:otherwise>
                                                                                                  <td>-</td>
                                                                                    ...
                                                                                    <c:forEach items="${byDateAndLedger}" var="list" varStatus="indexId">
                                                                                            <tr>
                                                                                                    ...
                                                                                                    <td>${list[1]}</td>
                                                                                                    <c:choose>
                                                                                                        <c:when test="${(list[4] == 'D') && (list[3] != null)}">
                                                                                                          <td>${list[3]}</td>
                                                                                                          <c:set var="totalDr" value="${totalDr + list[3]}" />
                                                                                                        </c:when>
                                                                                                        <c:otherwise>
                                                                                                          <td>-</td>
                                                                                                        </c:otherwise>
                                                                                                    ...
                                                                                                    <c:choose>
                                                                                                        <c:when test="${(list[4] == 'C') && (list[3] != null)}">
                                                                                                          <td>${list[3]}</td>
                                                                                                          <c:set var="totalCr" value="${totalCr + list[3]}" />
                                                                                                        </c:when>
                                                                                                        <c:otherwise>
                                                                                                          <td>-</td>
                                                                                                        </c:otherwise>
                                                                                             ...
                                                                                             <tr>
                                                                                                <td colspan="4"><b>To Closing Balance</b></td>
