...
<html lang="en">
	<head> 
		...
		<meta charset="utf-8" />
		<title>Accounting-Predefined Bill</title>
	...
	<body class="no-skin">
        ...
        <c:forEach items="${listGroup}" var="group">
            <c:choose>
                <c:when test="${group.moduleName=='Pre Defined Sale Bills'}">
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="PredefinedBillGrid.html">Predefined Bill Records</a>
							</li>
							<li class="active"> Predefined Bill</li>
						</ul><!-- /.breadcrumb -->
