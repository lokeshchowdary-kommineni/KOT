...
<html lang="en">
	...
	<body class="no-skin">
        ...
        <c:forEach items="${listGroup}" var="group">
            <c:choose>
                <c:when test="${group.moduleName=='ReversalofITCReports'}">
				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li>
								<a href="ReversalOfItc.html">ReversalofITC</a>
							</li>
                                                        <li>
								<a href="ReversalOfItcGrid.html">ReversalofITC Records</a>
							</li>
							<li class="active">ReversalofITC Reports</li>
						</ul><!-- /.breadcrumb -->
					...
					<div class="page-content">
                                                            ...
                                                            <!-- /.row -->
                                                       <div class="col-xs-12">
                                                           <form class="form-horizontal" action="GetReversalofITCReports.html"   method="POST" target="_blank">             
                                                               <div class="widget-box lighter  widget-color-blue2">
                                                                    <div class="widget-header">
                                                                <h5 class="widget-title">Reversal of ITC Reports</h5>
                                                                    </div>
										...
										<label for="id-date-picker-1">From Date</label>
																...
																<div class="input-group">
																	<input class="form-control date-picker" id="id-date-picker-1" type="text" value="${finalDate}" name="fromdate" data-date-format="dd/mm/yyyy" required/>
										...
										<label for="id-date-picker-1">To Date</label>
																...
																<div class="input-group">
																	<input class="form-control date-picker" id="id-date-picker-1" type="text" value="${curDate}" name="todate" data-date-format="dd/mm/yyyy" required/>
																	<span class="input-group-addon">
																		<i class="fa fa-calendar bigger-110"></i>
																	</span>
																</div>
