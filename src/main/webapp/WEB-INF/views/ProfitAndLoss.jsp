...
<html>
    ...
    <body class="no-skin">
        ...
        <c:forEach items="${listGroup}" var="group">
            <c:choose>
                <c:when test="${group.moduleName=='ProfitAndLoss'}">
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form  action="GetPF.html" method="POST">
								<div class="row">
                                                                    <div class="form-group col-xs-3">
                                                                                ...
                                                                                <div class="col-xs-8 col-sm-10">
                                                                                        <div class="input-daterange input-group">
                                                                                                <input type="text"  class="form-control date-picker" id="id-date-picker-1" name="startDate" value="${finalDate}" data-date-format="dd/mm/yyyy" required="true"/>
                                                                                                <span class="input-group-addon">
                                                                                                        <i class="fa fa-exchange"></i>
                                                                                                </span>

                                                                                                <input type="text" class="form-control date-picker" id="id-date-picker-1" name="endDate"  value="${curDate}" data-date-format="dd/mm/yyyy" required="true"/>
                                                                                        </div>
                                                                                </div>
                                                                                            ...
                                                                                            <c:forEach items="${ClosingStock}" var="cl">
                                                                                             ...
                                                                                             <c:forEach items="${StockjournalsOutValue}" var="stout">
                                                                                               ...
                                                                                               <!--INclude OPening Stock From Item Master--> 
                                                                                                <c:set var="OverAllClosingStock" value="${ClosingTot+ClosingTot_im}" />
